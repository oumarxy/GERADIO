...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'imagine.cache.manager' => 'getImagine_Cache_ManagerService',
            'imagine.cache.path.resolver' => 'getImagine_Cache_Path_ResolverService',
            'imagine.controller' => 'getImagine_ControllerService',
            'imagine.filter.loader.chain' => 'getImagine_Filter_Loader_ChainService',
            'imagine.filter.loader.paste' => 'getImagine_Filter_Loader_PasteService',
            'imagine.filter.loader.relative_resize' => 'getImagine_Filter_Loader_RelativeResizeService',
            'imagine.filter.loader.resize' => 'getImagine_Filter_Loader_ResizeService',
            ...
            'safric.form_manager' => 'getSafric_FormManagerService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \GestionBundle\Form\Extension\ImageTypeExtension A GestionBundle\Form\Extension\ImageTypeExtension instance.
     */
    protected function getApp_ImageTypeExtensionService()
    {
        return $this->services['app.image_type_extension'] = new \GestionBundle\Form\Extension\ImageTypeExtension();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gradio', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Members\\MembersBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Ventes\\VentesBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Gestion\\GestionBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Members\\MembersBundle\\Entity');
        $c->addDriver($b, 'Ventes\\VentesBundle\\Entity');
        $c->addDriver($b, 'Gestion\\GestionBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('MembersBundle' => 'Members\\MembersBundle\\Entity', 'VentesBundle' => 'Ventes\\VentesBundle\\Entity', 'GestionBundle' => 'Gestion\\GestionBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bdc982c890bb7616a958f816c6a73dd8754a45b6b3ef211aff439ce8f3e91093');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Members\\MembersBundle\\Entity\\AccountMember');
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('Members\\MembersBundle\\Entity\\AccountGroup');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.object_manager'), 'Members\\MembersBundle\\Entity\\AccountGroup');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Members\\MembersBundle\\Entity\\AccountMember');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Members\\MembersBundle\\Entity\\AccountMember');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Members\\MembersBundle\\Entity\\AccountMember');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.object_manager'), 'Members\\MembersBundle\\Entity\\AccountMember');
    }
    ...
    /**
     * Gets the 'imagine.cache.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Avalanche\Bundle\ImagineBundle\Imagine\CacheManager A Avalanche\Bundle\ImagineBundle\Imagine\CacheManager instance.
     */
    protected function getImagine_Cache_ManagerService()
    {
        return $this->services['imagine.cache.manager'] = new \Avalanche\Bundle\ImagineBundle\Imagine\CacheManager($this->get('imagine.cache.path.resolver'), $this->get('imagine.gd'), $this->get('imagine.filter.manager'), $this->get('filesystem'), ($this->targetDirs[2].'/../web'), ($this->targetDirs[2].'/../web'));
    }
    ...
    {
        return $this->services['imagine.cache.path.resolver'] = new \Avalanche\Bundle\ImagineBundle\Imagine\CachePathResolver(($this->targetDirs[2].'/../web'), $this->get('router'));
    }
    ...
    protected function getImagine_ControllerService()
    {
        ...
        return $this->services['imagine.controller'] = $this->scopedServices['request']['imagine.controller'] = new \Avalanche\Bundle\ImagineBundle\Controller\ImagineController($this->get('request'), $this->get('imagine.gd'), $this->get('imagine.cache.manager'), $this->get('imagine.filter.manager'));
    }

    /**
     * Gets the 'imagine.filter.loader.chain' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\ChainFilterLoader A Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\ChainFilterLoader instance.
     */
    protected function getImagine_Filter_Loader_ChainService()
    {
        return $this->services['imagine.filter.loader.chain'] = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\ChainFilterLoader($this->get('imagine.filter.manager'));
    }

    /**
     * Gets the 'imagine.filter.loader.paste' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader A Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader instance.
     */
    protected function getImagine_Filter_Loader_PasteService()
    {
        return $this->services['imagine.filter.loader.paste'] = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader($this->get('imagine.gd'));
    }

    /**
     * Gets the 'imagine.filter.loader.relative_resize' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\RelativeResizeFilterLoader A Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\RelativeResizeFilterLoader instance.
     */
    protected function getImagine_Filter_Loader_RelativeResizeService()
    {
        return $this->services['imagine.filter.loader.relative_resize'] = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\RelativeResizeFilterLoader();
    }

    /**
     * Gets the 'imagine.filter.loader.resize' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\ResizeFilterLoader A Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\ResizeFilterLoader instance.
     */
    protected function getImagine_Filter_Loader_ResizeService()
    {
        return $this->services['imagine.filter.loader.resize'] = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\Loader\ResizeFilterLoader();
    }
    ...
    {
        $this->services['imagine.filter.manager'] = $instance = new \Avalanche\Bundle\ImagineBundle\Imagine\Filter\FilterManager(array('my_thumb' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 100, 1 => 100), 'mode' => 'outbound'))));

        $instance->addLoader('thumbnail', $this->get('imagine.filter.loader.thumbnail'));
        $instance->addLoader('relative_resize', $this->get('imagine.filter.loader.relative_resize'));
        $instance->addLoader('resize', $this->get('imagine.filter.loader.resize'));
        $instance->addLoader('paste', $this->get('imagine.filter.loader.paste'));
        $instance->addLoader('chain', $this->get('imagine.filter.loader.chain'));
    ...
    {
        return $this->services['imagine.routing.loader'] = new \Avalanche\Bundle\ImagineBundle\Routing\ImagineLoader('media/cache', array('my_thumb' => array('type' => 'thumbnail', 'options' => array('size' => array(0 => 100, 1 => 100), 'mode' => 'outbound'))));
    }
    ...
    {
        return $this->services['knp_snappy.image'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Image(($this->targetDirs[2].'\\..\\bin\\wkhtmltoimage.exe.bat'), array(), array()), $this->get('monolog.logger.snappy', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['knp_snappy.pdf'] = new \Knp\Bundle\SnappyBundle\Snappy\LoggableGenerator(new \Knp\Snappy\Pdf(($this->targetDirs[2].'\\..\\bin\\wkhtmltopdf.exe.bat'), array(), array()), $this->get('monolog.logger.snappy', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    /**
     * Gets the 'safric.form_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Members\MembersBundle\Services\ManagedForm A Members\MembersBundle\Services\ManagedForm instance.
     */
    protected function getSafric_FormManagerService()
    {
        return $this->services['safric.form_manager'] = new \Members\MembersBundle\Services\ManagedForm();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/home/');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'date' => array('timezone' => 'Africa/Abidjan', 'format' => 'F j, Y H:i', 'interval_format' => '%d days'), 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        call_user_func(array(new \Symfony\Bundle\TwigBundle\DependencyInjection\Configurator\EnvironmentConfigurator('F j, Y H:i', '%d days', 'Africa/Abidjan', 0, '.', ','), 'configure'), $instance);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Members\\MembersBundle/Resources/views'), 'Members');
        $instance->addPath(($this->targetDirs[3].'\\src\\Ventes\\VentesBundle/Resources/views'), 'Ventes');
        $instance->addPath(($this->targetDirs[3].'\\src\\Gestion\\GestionBundle/Resources/views'), 'Gestion');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4b69f11b37f8d862a3de693cd0fa6788');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MembersBundle' => 'Members\\MembersBundle\\MembersBundle',
                'VentesBundle' => 'Ventes\\VentesBundle\\VentesBundle',
                'GestionBundle' => 'Gestion\\GestionBundle\\GestionBundle',
            ...
            'secret' => '4b69f11b37f8d862a3de693cd0fa6788',
            'locale' => 'fr',
            ...
            'kernel.secret' => '4b69f11b37f8d862a3de693cd0fa6788',
            ...
            'fos_user.model.user.class' => 'Members\\MembersBundle\\Entity\\AccountMember',
            ...
            'fos_user.model.group.class' => 'Members\\MembersBundle\\Entity\\AccountGroup',
            ...
            'safric.form_manager.class' => 'Members\\MembersBundle\\Services\\ManagedForm',
            ...
            'knp_snappy.pdf.binary' => ($this->targetDirs[2].'\\..\\bin\\wkhtmltopdf.exe.bat'),
            ...
            'knp_snappy.image.binary' => ($this->targetDirs[2].'\\..\\bin\\wkhtmltoimage.exe.bat'),
            ...
            'imagine.web_root' => ($this->targetDirs[2].'/../web'),
            'imagine.source_root' => ($this->targetDirs[2].'/../web'),
