 ...
 */
class CategorieProduit extends \Ventes\VentesBundle\Entity\CategorieProduit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ventes\\VentesBundle\\Entity\\CategorieProduit' . "\0" . 'id', '' . "\0" . 'Ventes\\VentesBundle\\Entity\\CategorieProduit' . "\0" . 'libelle', '' . "\0" . 'Ventes\\VentesBundle\\Entity\\CategorieProduit' . "\0" . 'prixHT', '' . "\0" . 'Ventes\\VentesBundle\\Entity\\CategorieProduit' . "\0" . 'lastUpdate', '' . "\0" . 'Ventes\\VentesBundle\\Entity\\CategorieProduit' . "\0" . 'utilisateur');
        }
