 ...
 */
class Conge extends \Gestion\GestionBundle\Entity\Conge implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Conge' . "\0" . 'id', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Conge' . "\0" . 'datedept', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Conge' . "\0" . 'dateretour', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Conge' . "\0" . 'employe');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Conge $proxy) {
