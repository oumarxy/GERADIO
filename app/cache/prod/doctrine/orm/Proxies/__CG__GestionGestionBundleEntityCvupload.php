 ...
 */
class Cvupload extends \Gestion\GestionBundle\Entity\Cvupload implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'id', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'libellecv', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'date', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'employe', 'path', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'file');
        }

        return array('__isInitialized__', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'id', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'libellecv', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'date', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'employe', '' . "\0" . 'Gestion\\GestionBundle\\Entity\\Cvupload' . "\0" . 'file');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cvupload $proxy) {
    ...
    public function setLibellecv($libellecv)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLibellecv', array($libellecv));

        return parent::setLibellecv($libellecv);
    }
    ...
    public function getLibellecv()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLibellecv', array());

        return parent::getLibellecv();
    }
